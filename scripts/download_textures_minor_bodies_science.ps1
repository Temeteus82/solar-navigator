...
function Save-Resized {
    ...
    try {
        ...
        if ($ExactHeight -gt 0 -and $MaxWidth -gt 0) {
            $resized = New-Object System.Drawing.Bitmap $MaxWidth, $ExactHeight
            $g = [System.Drawing.Graphics]::FromImage($resized)
            $g.InterpolationMode = [System.Drawing.Drawing2D.InterpolationMode]::HighQualityBicubic
            $g.DrawImage($bmp, 0, 0, $MaxWidth, $ExactHeight)
            $g.Dispose()
...
foreach ($name in 'ceres.png', 'vesta.png', 'pluto.jpg', 'charon.jpg', 'io.jpg', 'europa.jpg', 'ganymede.jpg', 'callisto.jpg') {
